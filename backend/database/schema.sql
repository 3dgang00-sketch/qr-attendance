...
CREATE TABLE scan_attempts_log (
    id SERIAL PRIMARY KEY,
    student_id INTEGER REFERENCES users(id),
    session_id UUID REFERENCES class_sessions(session_id),
...
CREATE INDEX idx_class_sessions_session_id ON class_sessions(session_id);
...
CREATE INDEX idx_scan_attempts_student_id ON scan_attempts_log(student_id);
CREATE INDEX idx_scan_attempts_session_id ON scan_attempts_log(session_id);
